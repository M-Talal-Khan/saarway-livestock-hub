      ...
      <main className="pt-24 pb-16 bg-background min-h-screen flex items-center justify-center">
        <div className="sw-glass-card rounded-2xl p-10 text-center max-w-md mx-4">
          ...
          <div className="flex flex-col gap-3">
            <Link href="/login" className="px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-sw-green-700 transition-colors sw-btn-glow">
              Login / Sign Up
            </Link>
          ...
          <div className="flex-1">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filtered.map(listing => (
                <Link key={listing.id} href={`/marketplace/${listing.id}`} className="bg-card rounded-xl border border-border overflow-hidden sw-card-hover">
