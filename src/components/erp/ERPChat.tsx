...
// Main export - renders based on location
export default function ERPChat() {
  const pathname = usePathname();

  // Only show on public pages (not ERP)
...
// Chat for public pages (buyers, visitors)
function PublicChat() {
  ...
  useEffect(() => {
    const sessionKey = "saarway_buyer_chat_session";
