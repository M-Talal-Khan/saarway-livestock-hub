      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="bg-card rounded-xl p-6 border border-border mb-8">
          ...
          <p className="font-medium text-foreground">
            <Link to={`/farms/${listing.farmId}`} className="text-primary hover:underline">{listing.farm}</Link>
          </p>
        ...
        {moreListing.length > 0 && (
          <section>
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              {moreListing.map(l => (
                <Link key={l.id} to={`/marketplace/${l.id}`} className="bg-card rounded-xl border border-border overflow-hidden sw-card-hover">
