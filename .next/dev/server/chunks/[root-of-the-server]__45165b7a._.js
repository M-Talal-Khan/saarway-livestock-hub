...
"[project]/app/api/farms/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const [farmsRes, listingsRes] = await Promise.all([
        admin.from("farms").select("id, farm_name, city").eq("is_active", true).order("farm_name", {
            ascending: true
        }),
        admin.from("listings").select("farm_id").eq("status", "active")
    ]);
    if (farmsRes.error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: farmsRes.error.message
    }, {
        status: 500
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__45165b7a._.js.map