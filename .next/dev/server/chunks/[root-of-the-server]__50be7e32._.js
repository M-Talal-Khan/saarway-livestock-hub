...
"[project]/app/api/marketplace/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const { data, error } = await admin.from("listings").select(`id, asking_price, photo_url, description, listed_at,
       cattle(cattle_code, breed, teeth, current_weight, gender, coat_color),
       stations(station_name, station_tag, city),
       farms(id, farm_name, city)`).eq("status", "active").order("listed_at", {
        ascending: false
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50be7e32._.js.map