...
"[project]/app/api/erp/health/treatments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let query = admin.from("treatments").select(`id, treatment_date, condition_name, treatment_given, medicine, cost, outcome, notes, cattle_id, station_id, cattle(cattle_code, breed), farm_users!recorded_by(full_name)`).eq("farm_id", session.farm_id).order("treatment_date", {
        ascending: false
    });
...
async function POST(request) {
    ...
    if (![
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Only vets can record treatments"
        }, {
            status: 403
        });
    }
    ...
    const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data: cattle } = await admin.from("cattle").select("id, station_id").eq("id", cattleId).eq("farm_id", session.farm_id).single();
    ...
    const { data, error } = await admin.from("treatments").insert({
        cattle_id: cattleId,
    ...
    }).select("id, treatment_date, condition_name, treatment_given, medicine, cost, outcome").single();
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__191f0bff._.js.map