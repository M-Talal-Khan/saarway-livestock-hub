...
"[project]/app/api/erp/finance/rent/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data, error } = await admin.from("rent_details").select(`id, rent_amount, rental_cycle, contract_start, contract_end, owner_name, owner_contact, payment_due_day, payment_status, last_paid_at, station_id, stations(station_name, station_tag, city)`).eq("farm_id", session.farm_id).order("created_at", {
        ascending: true
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a8aa3880._.js.map