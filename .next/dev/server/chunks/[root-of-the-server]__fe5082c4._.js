...
"[project]/app/api/erp/feed/logs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    let query = admin.from("feed_logs").select(`id, log_type, quantity, cost, notes, logged_at, station_id, feed_item_id, feed_items(name, unit), farm_users!logged_by(full_name), stations(station_name, station_tag)`).eq("farm_id", session.farm_id).order("logged_at", {
        ascending: false
    });
...
async function POST(request) {
    ...
    if (logType === "stock_in" && ![
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Only admin/manager can add stock"
        }, {
            status: 403
        });
    }
    const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data, error } = await admin.from("feed_logs").insert({
    ...
    }).select("id, log_type, quantity, cost, logged_at").single();
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe5082c4._.js.map