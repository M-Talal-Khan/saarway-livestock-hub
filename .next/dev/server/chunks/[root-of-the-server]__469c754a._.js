...
"[project]/app/api/erp/finance/salaries/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminClient"])();
    const { data, error } = await admin.from("salary_records").select(`id, staff_name, amount, payment_date, notes, farm_users!farm_user_id(full_name, role)`).eq("farm_id", session.farm_id).order("payment_date", {
        ascending: false
    });
...
async function POST(request) {
    ...
    if (!staffName || !amount || !paymentDate) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Staff name, amount and date are required"
        }, {
            status: 400
        });
    }
    ...
    }).select("id, staff_name, amount, payment_date").single();
    if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: error.message
    }, {
        status: 500
...
//# sourceMappingURL=%5Broot-of-the-server%5D__469c754a._.js.map