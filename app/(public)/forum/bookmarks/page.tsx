...
import { Bookmark, ArrowLeft, Pin, MessageCircle, Heart, Factory, User, LogIn } from "lucide-react";
...
export default function PublicBookmarksPage() {
  ...
  useEffect(() => {
    ...
    fetchBookmarks();
  }, [buyerUser, currentUser, supabase, isLoggedIn]);
    ...
    return (
      <div className="container mx-auto px-4 py-24 max-w-md text-center">
        <div className="bg-[#b2c9ab]/30 backdrop-blur-2xl rounded-[2rem] p-10 border border-white/30 shadow-2xl">
          <Bookmark className="w-12 h-12 text-sw-green-300 mx-auto mb-6" />
          <h1 className="text-2xl font-bold text-sw-green-950 mb-3">Saved Posts</h1>
          <p className="text-muted-foreground mb-8">Login to view your saved posts.</p>
    ...
    <div className="container mx-auto px-4 pb-8 pt-24 space-y-6">
      ...
      {loading ? (
        ...
        <Card className="p-10 text-center border-dashed border-2">
          ...
          <Button className="mt-4 gap-2 bg-sw-green-700 hover:bg-sw-green-800" onClick={() => router.push("/forum")}>
            Browse Forum
          </Button>
        </Card>
      ) : (
